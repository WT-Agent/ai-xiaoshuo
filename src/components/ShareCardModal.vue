    ...
    <div class="modal-content share-modal-content">
      ...
      <div id="share-card-node" class="share-card-wrapper">
        <div class="share-card-header">
          ...
          <span class="share-tag">小说创作与大纲设定</span>
        </div>
        ...
        <div class="share-card-footer">
          <div class="share-qrcode-area">
            ...
            <div class="share-tip-text">
              <span class="primary">扫码体验 AI 小说创作与大纲设定助手</span>
...
// 清理回复末尾的特殊标记 [XIAOSHUO_SCORES]...[/XIAOSHUO_SCORES]
const cleanContent = computed(() => {
  if (!props.content) return '';
  return props.content.replace(/\[XIAOSHUO_SCORES\][\s\S]*?\[\/XIAOSHUO_SCORES\]/gi, '').trim();
});
...
const handleCopy = async () => {
  try {
    const textToCopy = `【网腾无限AI - 小说创作与大纲设定专家】\n\n${cleanContent.value}\n\n体验小说AI助手：https://ai.wuxian.xyz`;
